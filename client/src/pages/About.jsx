          ...
          <Box display="flex" justifyContent="center" alignItems="center" sx={{ m: 3, mt: 5, ml: 5, mr: 5 }}>
            <CardContent>
              ...
              <Typography sx={{ color: '#FFFFFF' }} align="left" variant="h6">
                ...
                like Zoom&apos;s room creation to Omegle&apos;s randomized public chatting feature, we bring it all
                together for immerse conversations. POWOW allows you to either join an pre-existing room via a room
                code. Create your own unique chat room in a simple input. And join the public chat room whenever your
                feeling bored.
              </Typography>
            </CardContent>
          </Box>
